...
// // CreateSig ..
// func CreateSig(R *internal.ExtendedGroupElement, Ss ...*internal.FieldElement) Signature {
...
// 	internal.GeScalarMultBase(&A1, &sk1)
...
// 	signatureValid := Verify(publicKeyCurve, signatureCurve, message)
